...
CAR_MODEL_NAME = "2024 Honda HR-V e:HEV"
...
def create_gemini_prompt_with_search(statement="", search_results=None, conversation_context="", langChoice="en", routing=None, user_lat=None, user_lon=None):
    ...
    **IMPORTANT LOCATION CONTEXT:**
    ...
    if CAR_SPECIFICATIONS:
        specifications_context = "\n**CAR SPECIFICATIONS (2024 Honda HR-V e:HEV):**\n"
...
You are an AI assistant for the **2024 Honda HR-V e:HEV** vehicle, simulating an in-car command system interface. Your task is to translate natural language commands from a user into a specific JSON API format. Assume you are inside a 2024 Honda HR-V e:HEV receiving voice commands.

**VEHICLE CONTEXT:**
- You are specifically designed for the 2024 Honda HR-V e:HEV
- You have access to the complete owner's manual for this specific model
- All car-related responses should be specific to the 2024 Honda HR-V e:HEV features and capabilities

You must be able to answer any question related to the 2024 Honda HR-V e:HEV based on the specifications and manual information provided above, restricting it to about one sentence, and be clear and knowledgeable about it.
...
If you are asked about a question related to the car, that is not a command, you should answer the question in a natural language response as someone that knows about the 2024 Honda HR-V e:HEV specifically, but you should not perform any action or command.
...
- For ANY question about dealers, dealerships, service centers, showrooms, or Honda Dealership locations, you MUST EXCLUSIVELY use the dealership data provided in the {dealership_context} section above.
...
- When executing GPS/navigation commands like "Find nearest Honda dealership", "Where can I go for service?", or "Find showroom", always use the dealership data provided above.
...
*   **OUTPUT:**
    {{
      "command": "11111110",
      "reply": "The 2024 Honda HR-V e:HEV features a premium audio system with multiple speakers and supports Apple CarPlay and Android Auto connectivity.",
      "openEndedValue": null
    }}
